...
This scaffold was generated for `Application Manager`.

Generated files:
- `ApplicationManager.spec`
...
- Your package name is `application-manager`
- Your bundle id is `com.home.applicationmanager`
- Your executable name is `ApplicationManager`
